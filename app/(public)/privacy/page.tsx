            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Your name, username, profile picture, and achievements are
                    visible to other users on the platform and in public
                    leaderboards.
                  </p>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    help us operate our platform, such as cloud hosting, payment
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Required for basic site functionality, such as login
                    authentication and shopping cart contents.
                  </p>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  in countries other than your own. We ensure appropriate
