            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                  ...
                  <li>Submit plagiarized or copyrighted work without proper attribution</li>
              ...
              <section>
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    All content on the platform, including courses, materials, and software, is owned by 
                    us or our content providers and is protected by intellectual property laws.
                  </p>
                  <p>
                    You retain ownership of your submitted projects and coursework, but grant us a license 
                    to use, display, and distribute your work for educational purposes.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    Some courses and features may require payment. All fees are clearly displayed before purchase.
                  </p>
                  <p>
                    Refunds are available within 14 days of purchase if you're not satisfied with the course content.
                  </p>
                </div>
              </section>
