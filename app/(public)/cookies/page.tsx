            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  We use cookies for several purposes to enhance your experience on our learning platform:
                </p>

                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-foreground">Essential Cookies</h3>
                  <p className="text-muted-foreground mb-2">These cookies are necessary for the website to function:</p>
                  ...
                  <p className="text-muted-foreground mb-2">These cookies help us understand how our website performs:</p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                  ...
                  <p className="text-muted-foreground mb-2">These cookies enhance functionality and personalization:</p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                  ...
                  <p className="text-muted-foreground mb-2">These cookies help us understand user behavior:</p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                  ...
                  <p className="text-muted-foreground mb-2">These cookies are used for advertising and marketing:</p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-lg font-medium text-foreground">Cookie Consent Banner</h3>
                  ...
                  <h3 className="text-lg font-medium text-foreground">Opt-Out Tools</h3>
                  <p className="text-muted-foreground">
                    You can opt out of targeted advertising through industry opt-out programs like 
                    the Digital Advertising Alliance (DAA) and Network Advertising Initiative (NAI).
                  </p>
                </div>
              </section>
